...
const tableConfigs: Record<string, TableConfig> = {
  "Applicant Information": {
    ...
    columns: [
      ...
      { key: "employment_address", label: "Employment Address", db: "employment_address" },
      { key: "civil_status", label: "Civil Status", type: "select", options: ["Single", "Married", "Widowed"], db: "civil_status" },
      { key: "father_name", label: "Father's Name", db: "father_name" },
      { key: "mother_name", label: "Mother's Name", db: "mother_name" },
      { key: "spouse_name", label: "Spouse Name", db: "spouse_name" },
      { key: "spouse_citizenship", label: "Spouse Citizenship", db: "spouse_citizenship" },
    ],
    dbToLocal: { applicant_id: "applicant_id", surname: "surname", firstname: "firstname", sex: "sex", birth_date: "birth_date", birthplace: "birthplace", citizenship: "citizenship", applicant_address: "applicant_address", applicant_contact_num: "applicant_contact_num", occupation: "occupation", employment_address: "employment_address", civil_status: "civil_status", father_name: "father_name", mother_name: "mother_name", spouse_name: "spouse_name", spouse_citizenship: "spouse_citizenship" },
    localToDb: { applicant_id: "applicant_id", surname: "surname", firstname: "firstname", sex: "sex", birth_date: "birth_date", birthplace: "birthplace", citizenship: "citizenship", applicant_address: "applicant_address", applicant_contact_num: "applicant_contact_num", occupation: "occupation", employment_address: "employment_address", civil_status: "civil_status", father_name: "father_name", mother_name: "mother_name", spouse_name: "spouse_name", spouse_citizenship: "spouse_citizenship" },
  },
  "Passport Information": {
  ...
  "Application Information": {
    ...
    columns: [
      ...
      { key: "prev_had_visa", label: "Prev Had Visa", type: "number", db: "prev_had_visa" },
      { key: "sponsor_id", label: "Sponsor ID", type: "number", db: "sponsor_id" },
    ],
    dbToLocal: { application_id: "application_id", applicant_id: "applicant_id", port_of_entry: "port_of_entry", stay_length: "stay_length", entry_purpose: "entry_purpose", age_at_application: "age_at_application", companion_name: "companion_name", destination_after_phil: "destination_after_phil", prev_had_visa: "prev_had_visa", sponsor_id: "sponsor_id" },
    localToDb: { application_id: "application_id", applicant_id: "applicant_id", port_of_entry: "port_of_entry", stay_length: "stay_length", entry_purpose: "entry_purpose", age_at_application: "age_at_application", companion_name: "companion_name", destination_after_phil: "destination_after_phil", prev_had_visa: "prev_had_visa", sponsor_id: "sponsor_id" },
  },
  "Visa History": {
